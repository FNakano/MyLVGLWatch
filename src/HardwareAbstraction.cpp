 ...
 * 
 * developer: software layer to abstract out hardware details and give the user a clean interface to hardware features.
 * This file can get too big if too many hardware features are accessed. 
 * In this case, it can be split to cover groups of features.
 */
