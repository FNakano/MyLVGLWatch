 ...
 */
static lv_obj_t *cont = NULL;       /**< reference to the screen (container of graphical objects) */
static lv_obj_t *timeLabel = NULL;  /**< reference to graphical object: label to show time */
static lv_obj_t *infoLabel = NULL;  /**< reference to graphical object: label to show info (spec. date and batt) */
static lv_obj_t *leftLabel = NULL;  /**< reference to graphical object: label of the left button */
static lv_obj_t *rightLabel = NULL;  /**< reference to graphical object: label of the right button */

static int8_t curLev=0; /**< current brightness of the screen. */
...
static void createTimeButton (lv_obj_t *cont) {
    ...
    lv_obj_set_size(timeButton,240,90);
...
void createSideButtons (lv_obj_t *cont) {
    ...
    lv_obj_set_size(leftButton,40,80);
    ...
    lv_obj_set_size(rightButton,40,80);
